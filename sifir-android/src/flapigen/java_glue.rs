...
use crate::utils::{CallBack, CallBackResult};
use jni::*;
...
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_JNIReachabilityFence_reachabilityFence1(
    _env: *mut JNIEnv,
    _: jclass,
    _: jobject,
) {
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_JNIReachabilityFence_reachabilityFence2(
    _env: *mut JNIEnv,
    _: jclass,
    _: jobject,
    _: jobject,
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_JNIReachabilityFence_reachabilityFence3(
    _env: *mut JNIEnv,
    _: jclass,
    _: jobject,
    _: jobject,
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_JNIReachabilityFence_reachabilityFence4(
    _env: *mut JNIEnv,
    _: jclass,
    _: jobject,
    _: jobject,
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_JNIReachabilityFence_reachabilityFence5(
    _env: *mut JNIEnv,
    _: jclass,
    _: jobject,
    _: jobject,
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_JNIReachabilityFence_reachabilityFence6(
    _env: *mut JNIEnv,
    _: jclass,
    _: jobject,
    _: jobject,
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_JNIReachabilityFence_reachabilityFence7(
    _env: *mut JNIEnv,
    _: jclass,
    _: jobject,
    _: jobject,
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_JNIReachabilityFence_reachabilityFence8(
    _env: *mut JNIEnv,
    _: jclass,
    _: jobject,
    _: jobject,
...
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_TorServiceParam_do_1getDataDir(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) -> jstring {
    let this: &TorServiceParam =
        unsafe { jlong_to_pointer::<TorServiceParam>(this).as_mut().unwrap() };
    let mut ret: &str = { &this.data_dir };
    let mut ret: jstring = {
        let x = ::std::ffi::CString::new(ret).unwrap();
...
#[allow(non_snake_case, unused_variables, unused_mut, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_TorServiceParam_do_1getSockPort(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) -> jstring {
    let this: &TorServiceParam =
        unsafe { jlong_to_pointer::<TorServiceParam>(this).as_mut().unwrap() };
    let mut ret: &str = { &this.socks_port };
    let mut ret: jstring = {
        let x = ::std::ffi::CString::new(ret).unwrap();
        unsafe { (**env).NewStringUTF.unwrap()(env, x.as_ptr()) }
    };
...
#[allow(non_snake_case, unused_variables, unused_mut, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_TorServiceParam_do_1getPort(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) -> jstring {
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_TorServiceParam_do_1delete(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) {
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_OwnedTorService_init(
    env: *mut JNIEnv,
    _: jclass,
    param: jlong,
) -> jlong {
    ...
    let this: OwnedTorService = OwnedTorService::new(param);
    let this: Box<OwnedTorService> = Box::new(this);
    let this: *mut OwnedTorService = Box::into_raw(this);
    this as jlong
}
#[allow(non_snake_case, unused_variables, unused_mut, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_OwnedTorService_do_1shut_1down(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) -> () {
    ...
    let mut ret: () = OwnedTorService::shut_down(this);
    ret
}
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_sifir_sdk_OwnedTorService_do_1delete(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) {
...
pub extern "system" fn JNI_OnLoad(
    ...
    unsafe {
        let class_local_ref =
            (**env).FindClass.unwrap()(env, swig_c_str!("com/sifir/sdk/OwnedTorService"));
        assert!(
            !class_local_ref.is_null(),
            concat!("FindClass failed for ", "com/sifir/sdk/OwnedTorService")
        );
        let class = (**env).NewGlobalRef.unwrap()(env, class_local_ref);
        assert!(
            !class.is_null(),
    ...
    unsafe {
        let class_local_ref =
            (**env).FindClass.unwrap()(env, swig_c_str!("com/sifir/sdk/TorServiceParam"));
        assert!(
            !class_local_ref.is_null(),
            concat!("FindClass failed for ", "com/sifir/sdk/TorServiceParam")
        );
        let class = (**env).NewGlobalRef.unwrap()(env, class_local_ref);
        assert!(
            !class.is_null(),
